...
<!-- end about -->
    ...
    <section class="wrapper">
        ...
        <div class="container">
            ...
            <div id="scene" class="scene overflow-hidden" data-hover-only="false">
...
$bg-02: #1E2337;
$bg-03: #2f47a3;
$g-01: linear-gradient(90deg, #2D83EC 0%, #1AC9FF 100%);
$g-02: linear-gradient(90deg, #1AC9FF 13.7%, #2D83EC 94.65%);
