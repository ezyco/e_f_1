<template>
<div :class="{'w-full h-full  flex flex-col justify-end fixed top-0 z-40 bg-[rgba(23,23,23,0.5)] backdrop-blur-sm':true,'bg-show': isOpen,
        'bg-hide': !isOpen,}"></div>
<div class="w-[100vw] h-[100vh] fixed z-[110]  top-0 flex justify-center items-center">
    <div :class="{'w-[80vw] bg-white rounded-[2vw] transition-all duration-300':true,'popup-close':!isOpen,'popup-open':isOpen}">
        ...
        <div class="w-full mt-[3vw] mb-[4vw] flex justify-around items-center">
            <div class="basis-1/3 bg-red-700 text-white p-[1vw] rounded-[1vw] text-center roboto">Yes</div>
            <div class="basis-1/3 text-center roboto p-[1vw] rounded-[1vw] bg-[#1a8b45] text-white">Cancel</div>
        </div>
    </div>
</div>
</template>
